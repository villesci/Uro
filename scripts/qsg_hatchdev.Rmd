...
#scaling and centering our variables
 ...
 data2<-data.frame("lat"=scale(data$lat,center=T,scale=T),"mean"=scale(data$mean,center=T,scale=T),"s.mean"=scale(data$s.mean,center=T,
  ...
  ##THESE WORK, but slow! 
  a<-glmmTMB(no.embryos ~ 1+(1|momID), data=data,family=compois)
  b<-glmmTMB(no.embryos ~ lat+(1|momID),data=data,family=compois)
  c<-glmmTMB(no.embryos ~ mean+(1|momID),data=data,family=compois)
  d<-glmmTMB(no.embryos ~ s.mean+(1|momID),data=data,family=compois)
  e<-glmmTMB(no.embryos ~ q.mean+(1|momID),data=data,family=compois)
  f<-glmmTMB(no.embryos ~ t.mean+(1|momID),data=data,family=compois)
  g<-glmmTMB(no.embryos ~ lat+ocean+(1|momID),data=data,family=compois)
  h<-glmmTMB(no.embryos ~ mean+ocean+(1|momID),data=data,family=compois)
  i<-glmmTMB(no.embryos ~ s.mean+ocean+(1|momID),data=data,family=compois)
  j<-glmmTMB(no.embryos ~ q.mean+ocean+(1|momID),data=data,family=compois)
  k<-glmmTMB(no.embryos ~ t.mean+ocean+(1|momID),data=data,family=compois)
  l<-glmmTMB(no.embryos ~ max+(1|momID),data=data,family=compois)
  m<-glmmTMB(no.embryos ~ max+ocean+(1|momID),data=data,family=compois)
